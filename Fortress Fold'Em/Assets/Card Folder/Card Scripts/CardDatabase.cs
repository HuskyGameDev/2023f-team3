...
public class CardDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cardList.Add(new Card(6, "Gremlin", 1, 1, 4, "A mischievous creature known for causing trouble. +1 cards Next Turn.", Resources.Load<Sprite>("Gremlin")));

        cardList.Add(new Card(7, "Gnome", 2, 3, 4, "A small, clever creature with a penchant for technology. +3 Cards Next Turn.", Resources.Load<Sprite>("Gnome")));

        cardList.Add(new Card(8, "Goblin", 1, 1, 4, "A sneaky and cunning humanoid creature. +1 Card Next Turn.", Resources.Load<Sprite>("Goblin")));
        ...
        cardList.Add(new Card(13, "Centaur", 2, 2, 4, "A creature with the upper body of a human and the lower body of a horse. +2 Cards Next Turn.", Resources.Load<Sprite>("Centaur")));
        ...
        cardList.Add(new Card(20, "Dragon", 3, 4, 4, "A mighty and fire-breathing dragon. +4 Cards Next Turn", Resources.Load<Sprite>("Dragon")));
        ...
        cardList.Add(new Card(31, "The King in Yellow", 2, 4, 4, "A mysterious and malevolent entity. +4 Cards Next Turn.", Resources.Load<Sprite>("The King in Yellow")));

        cardList.Add(new Card(32, "Witch", 2, 3, 2, "A practitioner of dark magic. +3 Mana Next Turn", Resources.Load<Sprite>("Witch")));

        cardList.Add(new Card(33, "Bugbear", 2, 12, 3, "A fearsome humanoid creature. Deal 12 Damage.", Resources.Load<Sprite>("Bugbear")));
        ...
        cardList.Add(new Card(36, "Swine", 1, 1, 4, "A monstrous and grotesque pig-like creature. +1 Cards Next Turn", Resources.Load<Sprite>("Swine")));

        cardList.Add(new Card(37, "Cats of Nine", 1, 2, 4, "A magical cat with nine lives. +2 Cards Next Turn", Resources.Load<Sprite>("Cats of Nine")));

        cardList.Add(new Card(38, "Loyal Hound", 2, 14, 3, "A faithful and loyal canine companion. Deal 14 Damage.", Resources.Load<Sprite>("Faithful Hound")));
        ...
        cardList.Add(new Card(46, "Soldier", 1, 1, 4, "A trained and disciplined warrior. +1 Cards Next Turn", Resources.Load<Sprite>("Soldier")));
        ...
        cardList.Add(new Card(48, "King", 3, 4, 4, "A powerful and authoritative ruler. +4 Cards Next Turn", Resources.Load<Sprite>("King")));
